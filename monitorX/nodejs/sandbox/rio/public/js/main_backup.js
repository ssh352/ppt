...
$(document).ready(function () {
	...
	$("#Portfoilo_Minitor").click(function () {
		$("#Portfoilo_Minitor_div").show();//显示div  
		$("#Portfoilo_analyze_div").hide();//隐藏div  
	...
	$("#Portfoilo_analyze").click(function () {
		$("#Portfoilo_Minitor_div").hide();//显示div  
		$("#Portfoilo_analyze_div").show();//隐藏div  
		$("#Market_Minitor_div").hide();//隐藏div  
		$("#Process_Minitor_div").hide();
		$("#Product_Monitor_div").hide();
		$("#Theme_Minitor_div").hide();
	...
	$("#Process_Minitor").click(function () {
		$("#Portfoilo_Minitor_div").hide();
		$("#Portfoilo_analyze_div").hide();
	...
	//http://127.0.0.1:8081/Rfunc?cmd=statisticportindustry.indexweight(%22YH01%22,%2010,%20%22maxweight%22)&filename=
	$("#Button3").click(function () {
		if(!G_LOGIN){
			alert(G_WARN_MSG)
			return
		}
		var url = String.format('Rfunc?cmd=statisticportindustry.indexweight("{0}", 10, "maxweight")&filename=', $("#s_2").val());
		$.get(url, function (ret, status) {
			var data = new google.visualization.DataTable();
			data = JSONtoDatatable(ret);
...
jQuery(document).ready(function($){
	...
	$("#Portfoilo_Minitor").trigger("click");
