...
def calRatio(index1, index2, startDate, endDate):
    w.start()
    #wsddata1 = w.wsd("000905.SH,000016.SH", "close", "ED-3M", "2016-06-21", "")
    wsddata1 = w.wsd(index1+','+index2, 'close', "ED-3M", endDate, '')
...
if __name__ == "__main__":
    ...
    calRatio('000905.SH', '000016.SH', "2006-01-01", today)
